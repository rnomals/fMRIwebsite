<?php require_once('./db_con/view_all_post.php');
session_start();
?>
...
<html lang="en">
	...
	<body>
                ...
                <div class="pull-center">
                    <nav id="subnav">
                        ...
                        <ul>
                            ...
                            <li class="current"><a href="all_post.php">View Forum</a></li>
	                        <?php
	                        if(isset($_SESSION['username']) AND !empty($_SESSION['username'])){
        ...
        <div class="container">
            ...
            <!-------------------------------------------------------------------------------------------------------------------------------------->
                            <?php
                            while ($total_posts=$results_total_posts->fetch_assoc())
                            {
                            ?>
                                <tr>
                                    <td class="author-col">
                                        <div>by <a class="name"><i><?= $total_posts['fname'];?></i></a></div>
                                    ...
                                    <td class="post-col d-lg-flex justify-content-lg-between">
                                        <div><span class="font-weight-bold"><?= $total_posts['section'];?></span>: <?= $total_posts['topic'];?></div>
