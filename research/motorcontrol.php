...
<html lang="en">
  <head>
    ...
    <title>fMRI Data Portal | Motor Control</title>
                                ...
                                <ul>
                                    ...
                                    <li class="dropdown"><b>
                                        ...
                                        <ul class="dropdown-content" style="position: absolute" id="content">
                                            ...
                                            <li><a class="current" href="motorcontrol.php">Motor Control</a></li>
        ...
        <section id="page" class="contact">
            <div class="container">
                <p style="color: black;text-decoration: none;">
                    Motor Control function can be divided into several sub functions.To view research studies click sub functions.
                </p>
                <hr>
                ...
                <div class="btn-group-lg" id="buttons">
                    ...
                    <table>
                        <tr>
                            <td><button class="btn sen " data-id="0" >Hand/Arm Movements</button></td>
                            <td><button class="btn sen" data-id="1"> Leg/Limb Movements</button></td>
                            <td><button class="btn sen" data-id="2" > Neck Movements</button></td>

                        </tr>
                        <tr>
                            <td><button class="btn sen" data-id="3" > Basic trunk Movements</button></td>
                            <td><button class="btn sen" data-id="4" > Wrist/finger/thumb Movements</button></td>
                            <td><button class="btn sen" data-id="5" > Shoulder Movements</button></td>
                        </tr>
                        <tr>
                            <td> <button class="btn sen" data-id="6" > Eyelids Movements</button></td>
                            <td><button class="btn sen" data-id="7" > Lips Movements</button></td>
                        </tr>
                    </table>
