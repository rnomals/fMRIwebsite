...
<head>
    ...
    <title>fMRI Data Portal | Regulation</title>
...
<section id="page" class="contact">
    <div class="container">
        <p style="color: black;text-decoration: none;">
            Regulation function can be divided into several sub functions.To view research studies click sub functions.
        </p>
        <hr>
        ...
        <div class="btn-group-lg" id="buttons">
            ...
            <button class="btn sen" data-id="0" >Blood Presure Control</button>
            <button class="btn sen" data-id="1"> Heart Rate Control</button>
            <button class="btn sen" data-id="2" > Respiratory Control</button>
