...
<html lang="en">
  <head>
    ...
    <title>fMRI Data Portal | Language</title>
                                ...
                                <ul>
                                    ...
                                    <li class="dropdown"><b>
                                        ...
                                        <ul class="dropdown-content" style="position: absolute" id="content">
                                            ...
                                            <li><a class="current" href="language.php">Language</a></li>
        ...
        <section id="page" class="contact">
             <div class="container">
                 <p style="color: black;text-decoration: none;">
                     Language can be divided into several sub functions.To view research studies click sub functions.
                 </p>
                 <hr>
                 ...
                 <div class="btn-group-lg" id="buttons">
                     <table>
                         <tr>
                             <td><button class="btn sen" data-id="0" >Accessing Word meaning</button></td>
                             <td><button class="btn sen" data-id="1"> Language Comprehension</button></td>
                             <td><button class="btn sen" data-id="2" > Language Perception</button></td>
                         </tr>
                         <tr>
                             <td><button class="btn sen" data-id="3" > Language Processing</button></td>
                             <td><button class="btn sen" data-id="4" > Semantic Tasks</button></td>
                         </tr>
                     </table>
