...
<html lang="en">
  <head>
    ...
    <title>fMRI Data Portal | Cognition</title>
                                ...
                                <ul>
                                    ...
                                    <li class="dropdown"><b>
                                        ...
                                        <ul class="dropdown-content" style="position: absolute" id="content">
                                            <li><a  href="sensory.php">Sensory</a></li>
                                            ...
                                            <li><a class="current" href="cognition.php">Cognition</a></li>
                                        </ul>
                                    </li>
        ...
        <section id="page" class="contact">
             <div class="container">
                 <p style="color: black;text-decoration: none;">
                     Executive function can be divided into several sub functions.To view research studies click sub functions.
                 </p>
                 <hr>
                 ...
                 <div class="btn-group-lg" id="buttons">
                    <table>
                        <tr>
                            <td><button class="btn sen" data-id="0" >Decission Making</button></td>
                            <td><button class="btn sen" data-id="1"> Face Perception</button></td>
                            <td><button class="btn sen" data-id="2" > Number Perception</button></td>
                            <td><button class="btn sen" data-id="3" > Making Awareness</button></td>
                        </tr>

                        <tr></tr>

                        <tr>
                            <td><button class="btn sen" data-id="4" > Management of Coognitive</button></td>
                            <td><button class="btn sen" data-id="5" > Memory Formation</button></td>
                            <td><button class="btn sen" data-id="6" > Memory Recall</button></td>
                        </tr>
                    </table>
