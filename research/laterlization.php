...
<html lang="en">
  <head>
    ...
    <title>fMRI Data Portal | Laterlization</title>
                                ...
                                <ul>
                                    ...
                                    <li class="dropdown"><b>
                                        ...
                                        <ul class="dropdown-content" style="position: absolute" id="content">
                                            ...
                                            <li><a class="current" href="laterlization.php">Laterlization</a></li>
        ...
        <section id="page" class="contact">
             <div class="container">
                 <p style="color: black;text-decoration: none;">
                     Laterlization function can be divided into several sub functions.To view research studies click sub functions.
                 </p>
                 <hr>
